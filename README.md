...
**Changes made:**
- 🔹 Updated the Blocking of open email (Allowing only Atleader Email to Register and Login), to    Maintain organizational Environment , changes in `packages/auth/server/types/email-password.ts` and
